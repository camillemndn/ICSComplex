...
$(\operatorname{Cov}, \operatorname{Cov}_4)$ (see Examples
[1](#ex:cov)), and compute
the eigenvalues $\lambda_1 \geq \ldots \geq \lambda_p$, and the
invariant coordinates $z_{ji}, 1 \leq j \leq p$, for each observation
$X_i, 1 \leq i \leq n$. As outlined in @sec-icscoord in
...
-   the knots are either located at the quantiles of the temperature
    values (top panel on @fig-vnt_north_south_grid) or equally spaced (bottom panel on @fig-vnt_north_south_grid),
