...
$(x,y) \in F^2$, $$\begin{aligned}
    ...
    &= \mathbb E [ w_\ell (\| \operatorname{Cov}^E [X]^{-1/2} \tilde X \|_E)^2 \langle \tilde X, \varphi^{-1} (x) \rangle_E \langle \tilde X, \varphi^{-1} (y) \rangle_E ] \label{eq-cor-isometry-covw1} \\
    &= \mathbb E [ w_\ell (\| \operatorname{Cov}^F [\varphi(X)]^{-1/2} \varphi(\tilde X) \|_F)^2 \langle \varphi(\tilde X), x \rangle_F \langle \varphi(\tilde X), y \rangle_F ]  \label{eq-cor-isometry-covw2} \\
    \langle \varphi \circ \operatorname{Cov}_{w_\ell}^E [X] \circ \varphi^{-1} (x), y \rangle_F
    &= \langle \operatorname{Cov}_{w_\ell}^F [\varphi(X)] x, y \rangle_F.
\end{aligned}$$ It is enough to show the equality between
@eq-cor-isometry-covw1 and
@eq-cor-isometry-covw2, for which we treat differently the
...
&=& \langle \operatorname{Cov}_{w_\ell} (G_B^{1/2} [X]_B) G_B^{1/2} [x]_B, G_B^{1/2} [y]_B \rangle_{\mathbb R^p} \label{eq-cor-coord1} \\
&=& \langle \operatorname{Cov}_{w_\ell} (G_B [X]_B) [x]_B, [y]_B \rangle_{\mathbb R^p} \label{eq-cor-coord2} \\
&=& \langle \operatorname{Cov}_{w_\ell} ([X]_B) G_B [x]_B, G_B [y]_B \rangle_{\mathbb R^p}, \label{eq-cor-coord3}
\end{aligned}$$ where
@eq-cor-coord1 comes from the equation
@eq-isometry-covw, and the equalities
@eq-cor-coord2 and
@eq-cor-coord3 come from the affine equivariance of
